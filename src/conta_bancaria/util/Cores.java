...
public class Cores {
	...
	public static String temaMenu = Cores.TEXT_GREEN_BOLD_BRIGHT + Cores.ANSI_BLACK_BACKGROUND;
	public static String temaErros = Cores.TEXT_RED_BOLD + Cores.ANSI_BLACK_BACKGROUND;
	public static String temaMenu2 = Cores.TEXT_YELLOW_BOLD_BRIGHT + Cores.ANSI_BLACK_BACKGROUND;
	public static String confirmacao = Cores.TEXT_GREEN_BOLD_BRIGHT;
